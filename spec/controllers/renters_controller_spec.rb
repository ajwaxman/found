...
describe RentersController do
  ...
  # RentersController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested renter as @renter" do
      renter = Renter.create! valid_attributes
      get :show, {:id => renter.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested renter as @renter" do
      renter = Renter.create! valid_attributes
      get :edit, {:id => renter.to_param}, valid_session
      assigns(:renter).should eq(renter)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Renter" do
        expect {
          post :create, {:renter => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved renter as @renter" do
        ...
        post :create, {:renter => {}}, valid_session
        assigns(:renter).should be_a_new(Renter)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested renter" do
        ...
        Renter.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => renter.to_param, :renter => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested renter as @renter" do
        renter = Renter.create! valid_attributes
        put :update, {:id => renter.to_param, :renter => valid_attributes}, valid_session
        assigns(:renter).should eq(renter)
      end
    ...
    describe "with invalid params" do
      it "assigns the renter as @renter" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Renter.any_instance.stub(:save).and_return(false)
        put :update, {:id => renter.to_param, :renter => {}}, valid_session
        assigns(:renter).should eq(renter)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested renter" do
      renter = Renter.create! valid_attributes
      expect {
        delete :destroy, {:id => renter.to_param}, valid_session
      }.to change(Renter, :count).by(-1)
    end
